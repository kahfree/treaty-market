...
<html lang="en">
  ...
  <script>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#c9ffe5">
      <div class="container">
  <a class="navbar-brand" href="<?php echo base_url();?>/Customer"><img src="<?=base_url()?>/assets/images/site/logo2_small.png"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <span class="nav-item navbar-nav">
        <a class="nav-link"  data-toggle="tooltip" title="View Cart" href="<?php echo base_url();?>/viewCart"><ion-icon name="cart-sharp" style="font-size:2em;" ></ion-icon></a>
      </span>
